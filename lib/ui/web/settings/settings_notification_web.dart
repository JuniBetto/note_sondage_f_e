...
class _SettingsNotificationWebState extends State<SettingsNotificationWeb> {
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildSwitchTile(
                        ...
                        title: localization.taskNotifications,
                        subtitle: localization.taskNotificationsSubtitle,
                        value: preferences.taskRemindersEnabled,
                        onChanged: (v) => _updatePreferences(
                          context,
                          preferences.copyWith(taskRemindersEnabled: v),
                        ),
                        showDivider: true,
                      ),
                      _buildSwitchTile(
                        ...
                        title: localization.eventNotifications,
                        subtitle: localization.eventNotificationsSubtitle,
                        value: preferences.eventRemindersEnabled,
                        onChanged: (v) => _updatePreferences(
                          context,
                          preferences.copyWith(eventRemindersEnabled: v),
                        ),
                        showDivider: false,
                      ),
                    ],
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              OutlinedButton(
                                onPressed: () =>
                                    _runDebugShiftPipeline(context),
  ...
  Future<void> _runDebugCurrentShiftMode(BuildContext context) async {
    ...
    AppSnackBar.showSuccess(
      context,
      'A shift reminder was scheduled with the currently selected mode. Put the app in background before it fires.\n$result',
