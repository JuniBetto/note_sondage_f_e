...
class TeamBloc extends Bloc<TeamEvent, TeamState> {
  ...
  Future<void> _onCreateTeam(
    ...
    final optimisticTeam = TeamEntity(
      ...
      clockingRequiredEndDate: event.team.clockingRequiredEndDate,
  ...
  Future<void> _onRemoveTeamFromCache(
    ...
    final sourceTeams = _cachedTeams.isNotEmpty
        ? List<TeamEntity>.from(_cachedTeams)
        : await teamUseCase.getLocalTeams();
    final previousLength = sourceTeams.length;
    _cachedTeams = sourceTeams.where((team) => team.id != teamId).toList();
  ...
  TeamEntity _teamEntityFromUpdate(TeamUpdate update, {TeamEntity? previous}) {
    return TeamEntity(
      ...
      clockingRequiredEndDate: update.clockingRequiredEndDate,
