...
class UserUseCase {
  ...
  // Only one definition for getAllUsersByTeamId should exist, returning List<UserEntityForUpdate>
  ...
  Future<List<UserEntityForUpdate>> getAllUsersByTeamId(String teamId) async {
    try {
