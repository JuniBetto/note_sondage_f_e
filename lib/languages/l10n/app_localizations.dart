...
abstract class AppLocalizations {
  ...
  /// No description provided for @deleteTeamMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @swipeToCreateRole.
  ///
  /// In en, this message translates to:
  /// **'Swipe to create a new role'**
  String get swipeToCreateRole;

  /// No description provided for @searchTeamsByNameOrDescription.
  ///
  /// In en, this message translates to:
  /// **'Search teams by name or description'**
  String get searchTeamsByNameOrDescription;

  /// No description provided for @noTeamsMatchingSearch.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @noVisibleTeams.
  ///
  /// In en, this message translates to:
  /// **'No visible teams.'**
  String get noVisibleTeams;
  ...
  /// No description provided for @noPermissionToEditSurvey.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @deleteSurveyMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @archiveSurvey.
  ///
  /// In en, this message translates to:
  /// **'Archive survey'**
  String get archiveSurvey;

  /// No description provided for @restoreSurvey.
  ///
  /// In en, this message translates to:
  /// **'Restore survey'**
  String get restoreSurvey;

  /// No description provided for @noDraftOrActiveSurveysAvailable.
  ///
  /// In en, this message translates to:
  /// **'No draft or active surveys available'**
  String get noDraftOrActiveSurveysAvailable;

  /// No description provided for @noSurveysMatchingSearch.
  ///
  /// In en, this message translates to:
  /// **'No surveys found for this search.'**
  String get noSurveysMatchingSearch;

  /// No description provided for @noArchivedSurveys.
  ///
  /// In en, this message translates to:
  /// **'No archived surveys.'**
  String get noArchivedSurveys;

  /// No description provided for @noVisibleSurveys.
  ///
  /// In en, this message translates to:
  /// **'No visible surveys.'**
  String get noVisibleSurveys;
  ...
  /// In en, this message translates to:
  /// **'Delete shift'**
  String get deleteShiftTitle;

  /// No description provided for @deleteShiftMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @visibleToTeamMembers.
  ///
  /// In en, this message translates to:
